---
title: "Filter microbiome data (results) AD stool"
...
Non filtered phyloseq, stool samples

```{r import data}
# Phyloseq object MS samples
d.ps.ad.st <- "~/Documents"
ps.ad.st <- "diversity_test /ps.diversity.kompremiert.rds" %>%
  paste0(d.ps.ad.st,"/", .) %>% 
  readRDS() 
ps.ad.st
...
```{r}
"1.ps.filter.pd.abundance.kompremiert.rds" %>%
  saveRDS(ps1, .)
